    ...
    try:
        ...
        for idx, row in enumerate(sheet.iter_rows(min_row=2, values_only=True), start=2):
            ...
            mensaje = (
                ...
                f"\n🛠️ Le recordamos que tiene hasta el día *viernes 28 de junio del presente año* para retirar su equipo. Después de esta fecha, el equipo será trasladado a nuestra bodega para atender otros casos. Le sugerimos recogerlo lo antes posible para evitar cualquier inconveniente.\n"

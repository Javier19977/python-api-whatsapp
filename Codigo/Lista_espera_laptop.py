...
def main():
    ...
    try:
        ...
        for row in sheet.iter_rows(min_row=2, values_only=True):  # Empezar desde la segunda fila
            ...
            if not numero or not nombre_estudiante or not nombre_tecnico or not falla_reportada or not nie or not serie:
            ...
            mensaje = (
                ...
                f"\n📱 Desde el Ministerio de Educación, necesitamos que vengas con el equipo que has reportado en nuestra lista de espera con"
                f" la siguiente falla: *{falla_reportada}* - Serie del equipo: *{serie}*.\n"
                ...
                f"\n📍 *Dirección*: Estamos ubicados a una cuadra del ISSS Santa Ana, en Avenida California, colonia El Palmar, CE INSA Industrial. [Ver ubicación](https://maps.app.goo.gl/9G4GNo8RE63VKH6r6)\n"
